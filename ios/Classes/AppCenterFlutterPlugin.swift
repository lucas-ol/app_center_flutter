...
public class SwiftAppCenterFlutterPlugin: NSObject, FlutterPlugin {
  public static func register(with registrar: FlutterPluginRegistrar) {
    let channel = FlutterMethodChannel(name: "lucas.melo.flutter_app_center_flutter", binaryMessenger: registrar.messenger())
    let instance = SwiftAppCenterFlutterPlugin()
